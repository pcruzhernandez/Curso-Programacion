tableextension 50100 "Cutomer [CC]" extends Customer
{
    fields
    {
        field(50100; "Beer Category Code [CC]"; Code[20])
        {
        ...
        field(50101; "Beer Category Name [CC]"; Code[20])
        {
        ...
        field(50102; "Favorite Beer [CC]"; Code[20])
        {
        ...
        field(50103; "Favorite Beer Name [CC]"; Text[50])
        {
